...
export default function Pricing() {
  return (
    <section id="pricing" className="py-16 bg-base-200 relative">
      {/* Elementos decorativos - Mejorados para ambos temas */}
      <div className="absolute opacity-10 dark:opacity-20 top-0 left-0 right-0 overflow-hidden">
      ...
      <div className="container px-4 md:px-8 mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-base-content">Planes y Precios</h2>
          <p className="mt-4 text-lg text-base-content/80 max-w-2xl mx-auto">
            Elige el plan que mejor se adapte a tus necesidades y comienza a diseñar sistemas más rápido que nunca.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-base-content/70 mb-4">¿Tienes dudas sobre qué plan elegir?</p>
          <Link href="#contact" className="btn btn-outline btn-sm hover:bg-base-300/50">
