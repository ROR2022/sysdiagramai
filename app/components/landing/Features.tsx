...
export default function Features() {
  return (
    <section id="features" className="py-16 bg-base-100 relative">
      ...
      <div className="container px-4 md:px-8 mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-base-content">Características Principales</h2>
          <p className="mt-4 text-lg text-base-content/80 max-w-2xl mx-auto">
            SysDiagramAI simplifica el proceso de diseño de sistemas con herramientas potentes y una interfaz intuitiva.
          </p>
        </div>
            ...
            <div key={index} className="card bg-base-200 shadow-md hover:shadow-lg transition-all hover:translate-y-[-5px] duration-300">
              <div className="card-body p-6">
                <div className="flex items-center mb-4">
                  <div className="p-3 bg-primary/10 rounded-lg text-primary mr-3">
                    {feature.icon}
                  </div>
                ...
                <div className="card-actions mt-4">
                  <button className="btn btn-ghost btn-sm px-0 flex items-center text-primary">
